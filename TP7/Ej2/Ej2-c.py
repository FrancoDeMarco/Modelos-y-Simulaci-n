...
media_ocupación_cajero1 = np.mean(tiempo_ocupado_cajero1)
media_ocupación_cajero2 = np.mean(tiempo_ocupado_cajero2)
media_ocupación_cajero3 = np.mean(tiempo_ocupado_cajero3)
print(f"Porcentaje de tiempo de ocupación de la caja 1: {media_ocupación_cajero1*100:.2f}%")
print(f"Porcentaje de tiempo de ocupación de la caja 2: {media_ocupación_cajero2*100:.2f}%")
print(f"Porcentaje de tiempo de ocupación de la caja 3: {media_ocupación_cajero3*100:.2f}%")
